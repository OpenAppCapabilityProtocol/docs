...
- **Sensitivity slider** exposed via the Settings screen (the screen itself shipped in PR #21 with a wake word on/off toggle — sensitivity is the next dial to land there).
