...
```json
{
  ...
  "invoke": { "android": { "type": "broadcast", "action": "__APPLICATION_ID__.ACTION_GET_WEATHER" } },
  "completionMode": "async_result",
  "resultTransport": { "android": { "type": "broadcast", "action": "org.oacp.ACTION_RESULT" } }
}
```
...
```json
{
  ...
  "invoke": { "android": { "type": "activity", "action": "__APPLICATION_ID__.ACTION_TAKE_PHOTO" } },
...
```json
{
  ...
  "parameters": [
    { "name": "minutes", "type": "integer", "required": true, "minimum": 1, "maximum": 120 }
  ],
  "invoke": { "android": { "type": "broadcast", "action": "__APPLICATION_ID__.ACTION_SET_TIMER" } }
}
```
